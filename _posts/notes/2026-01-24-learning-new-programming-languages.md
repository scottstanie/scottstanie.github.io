...
Now I question whether there are benefits to learning more than the basics of a new programming language: will I ever get good enough to spot-check them? Or is the choice of language for a project is more like a high-level managerial decision. "What language would this tool be best in?" is a real question you can ask when starting a project, if you're willing to give up the idea that you'll understand the code.
