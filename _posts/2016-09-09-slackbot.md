...
- What you can make on slack
  - Simplest: just use their web API: https://api.slack.com/web
    - This was how I made "your turn" notifications in codenames
    - This can be as little as 2 lines of code in any web app (import slackclient, send)

  - Webhooks (incoming/ outgoing)
    - https://api.slack.com/incoming-webhooks : e.g. Github notifications, docker builds on registry
    - https://api.slack.com/outgoing-webhooks : e.g. listen to a channel, have a trigger run on a keyword
  - Slash commands: https://api.slack.com/slash-commands
    - This is often the easiest way to set up some connection to a web app you have
      - You can send yourself data in whatever form you choose
      - You can make the slash command before you create an app
  - Bot Users: https://api.slack.com/bot-users
    - commonly uses the RTM API https://api.slack.com/rtm
      - This uses websockets
    - Can be very dumb
      - increasing sophistication quickly adds difficulty
  - Extras for full slack apps (message buttons, easy install buttons, distribution)
  https://api.slack.com/slack-apps

- setup for basic slash command and messaging bot
...
>>> sc.api_call('chat.postMessage', channel='@scott', text='I am a robot', as_user=True)
{% endhighlight %}

{% include image.html url="/images/slackimages/createbot4.png" height="280" width="450" %}

The full list of API calls you can make is here: https://api.slack.com/methods
...
ngrok's description is "I want to expose a local server behind a NAT or firewall to the internet."
...
I didn't know there was a 2. But with ngrok running, you can be testing out your app locally like normal, checking `http://localhost:8000`, and also see the same app running on `https://b2098153.ngrok.io` or whatever the URL that it gives you.
